...
public enum AuthorityType implements GrantedAuthority {
    ...
    GET_SIM_CARDS, GET_SIM_CARD, CREATE_SIM_CARD, UPDATE_SIM_CARD, DELETE_SIM_CARD, SET_TARIFF, SET_PASSPORT, ADD_BALANCE, ADD_SERVICE, REMOVE_SERVICE, CRUD_SIM_CARD,

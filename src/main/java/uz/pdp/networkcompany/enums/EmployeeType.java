...
public enum EmployeeType {
    ...
    SIM_CARD_MANAGER(Set.of(CRUD_SIM_CARD, SET_TARIFF, SET_PASSPORT, ADD_BALANCE, ADD_SERVICE, REMOVE_SERVICE, ADD_PACKAGE)),
    BRANCH_MANAGER(Set.of(CRUD_BRANCH_LEADER, CRUD_BRANCH, CRUD_WORKER, SET_BRANCH_LEADER)),
    SERVICE_MANAGER(Set.of(CRUD_CATEGORY, CRUD_SERVICE, SET_CATEGORY)),
    PACKAGE_MANAGER(Set.of(CRUD_PACKAGE)),
